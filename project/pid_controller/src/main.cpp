...
int main ()
{
  ...
  **/
  ...
  PID pid_steer = PID();
  // pid_steer.Init(0.5, 0.01, 0.5, 1.2, -1.2); //case 1
  // pid_steer.Init(0.4, 0.001, 0.35, 1.2, -1.2); // case 2
  pid_steer.Init(0.4, 0.001, 0.35, 1.2, -1.2); // case 3



  PID pid_throttle = PID();
  // pid_throttle.Init(0.5, 0.001, 0.5, 1.0, -1.0); //case 1
  // pid_throttle.Init(0.2, 0.001, 0.02, 1.0, -1.0);// case 2
pid_throttle.Init(0.2, 0.0015, 0.04, 1.0, -1.0); // case 3
